...
<title>ГРАНД-РЕМОНТ | ремонт «под ключ» в Краснодаре</title>
...
<!-- CSS -->
<link href="style.thank-you.css" rel="stylesheet" type="text/css" />
<!-- /CSS -->
...
<div id="main">
    ...
    <!-- ======= Картинка ======= -->
	<center class="zagolovok"><img class="header_logo-img" src="images/logo.png" alt=""></center>
